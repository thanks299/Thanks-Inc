...
export default function Home() {
  return (
    <main className="pt-16">
      {/* Hero Section */}
      <section 
        className="h-screen bg-cover bg-center flex items-center transition-all duration-700 animate-fadeIn"
        style={{
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-white mb-12 text-center animate-fadeIn">Our Companies</h2>
